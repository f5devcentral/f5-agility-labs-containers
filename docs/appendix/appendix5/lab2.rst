...
#. Create new OpenShift HostSubnet's for bigip 1 & 2 on **POD1**.
   ...
   .. literalinclude:: openshift/hs-bigip1-10.yaml
      :language: yaml
      :emphasize-lines: 4,8,9

   hs-bigip2-10.yaml

   .. literalinclude:: openshift/hs-bigip2-10.yaml
      :language: yaml
      :emphasize-lines: 4,8,9

   hs-bigip-float-10.yaml

   .. literalinclude:: openshift/hs-bigip-float-10.yaml
      :language: yaml
      :emphasize-lines: 4,8,9
...
#. Create new OpenShift HostSubnet's for bigip 1 & 2 on **POD2**.
   ...
   .. literalinclude:: openshift/hs-bigip1-20.yaml
      :language: yaml
      :emphasize-lines: 4,8,9

   hs-bigip2-20.yaml

   .. literalinclude:: openshift/hs-bigip2-20.yaml
      :language: yaml
      :emphasize-lines: 4,8,9

   hs-bigip-float-20.yaml

   .. literalinclude:: openshift/hs-bigip-float-20.yaml
      :language: yaml
      :emphasize-lines: 4,8,9
