...
.. warning::
  ...
  .. image:: /_static/class3/f5-asp-and-controller-check-mesos-dns-state.png
    :align: center
    :scale: 50%
...
.. image:: /_static/class3/f5-asp-and-controller-check-backend-and-asp-deployment.png
  :align: center
  :scale: 50%
...
.. image:: /_static/class3/f5-asp-and-controller-check-asp-instances-deployed.png
  :align: center
  :scale: 50%

If you are connected to the backend instances, it works as expected:

.. image:: /_static/class3/f5-asp-and-controller-access-asp.png
  :align: center
  :scale: 50%
...
.. image:: /_static/class3/f5-asp-and-controller-access-backend.png
  :align: center
  :scale: 50%
